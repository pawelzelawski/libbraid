...
# Test source files
TEST_SRCS = tests/run_tests.c tests/test_table.c tests/test_state_machine.c tests/test_wait_queue.c tests/test_reconnect.c tests/test_reaper.c tests/test_pool.c
